        ...
        if (lista != null) {
            ...
            if (lista.size() > 0) {
                ...
                for (SocioNegocioBean socioNegocio : lista) {
                    ...
                    objetForInsert.put(contexto.getResources().getString(R.string.C_SN_MONEDA), socioNegocio.getMoneda());
                    objetForInsert.put(contexto.getResources().getString(R.string.C_SN_SALDO_CUENTA), socioNegocio.getSaldoCuenta());
                    objetForInsert.put(contexto.getResources().getString(R.string.C_SN_DESCUENTO), socioNegocio.getPorcentajeDescuento());
                    objetForInsert.put(contexto.getResources().getString(R.string.C_SN_DESCUENTO_BASE), socioNegocio.getPorcentajeDescuentoBase());
                                ...
                                if (!direccion.getIDDireccion().equalsIgnoreCase(
                                    ...
                                    db.execSQL(
                                            ...
                                            new Object[]{
                                                    ...
                                                    direccion.getNumeroUltimaCompra(),
                                                    direccion.getFechaUltimaCompra(),
                                                    direccion.getMontoUltimaCompra()});
...
//				delete.deleteSocioNegocio();
    ...
    public boolean insertOrdenVenta(OrdenVentaBean ordenVenta) {
        ...
        objetForInsert.put(contexto.getResources().getString(R.string.C_OV_IMPUESTO), ordenVenta.getImpuesto());
        objetForInsert.put(contexto.getResources().getString(R.string.C_OV_TOTAL), ordenVenta.getTotal());
        objetForInsert.put(contexto.getResources().getString(R.string.C_OV_DESCUENTO), ordenVenta.getPorcDesc());
        objetForInsert.put(contexto.getResources().getString(R.string.C_OV_CREAD_MOVIL), ordenVenta.getCreadoMovil());
        objetForInsert.put(contexto.getResources().getString(R.string.C_OV_CLAVE_MOVIL), ordenVenta.getClaveMovil());
        ...
        if (lista != null) {
            ...
            if (lista.size() > 0) {
                ...
                for (FacturaBean factura : lista) {
                    ...
                    objetForInsert.put(contexto.getResources().getString(R.string.C_FACT_DIAS), factura.getDias());
        ...
        if (lista != null) {
            ...
            if (lista.size() > 0) {
                ...
                for (ListaPrecioBean bean : lista) {
                    ...
                    objetForInsert.put(contexto.getResources().getString(R.string.C_LST_PRE_CUR), bean.getMoneda());
    ...
    public boolean insertTipoCambio(List<TipoCambioBean> lista) {
        ...
        if (lista != null) {
            ...
            if (lista.size() > 0) {
                res = true;
                db.beginTransaction();
                db.execSQL("DELETE FROM " + contexto.getResources().getString(R.string.T_TIPO_CAMBIO));

                for (TipoCambioBean bean : lista) {
                    db.execSQL(
                            "INSERT into "
                                    + contexto.getResources().getString(R.string.T_TIPO_CAMBIO)
                                    + "(" + contexto.getResources().getString(R.string.C_TC_FEC) + ","
                                    + contexto.getResources().getString(R.string.C_TC_MON) + ","
                                    + contexto.getResources().getString(R.string.C_TC_TAS) + ") " +
                                    " values(?, ?, ?)",
                            new Object[]{bean.getFecha(),
                                    bean.getMoneda(),
                                    bean.getTasa()});
    ...
    public boolean insertZonas(List<ZonaBean> lista) {
        ...
        if (lista != null) {
            ...
            if (lista.size() > 0) {
                res = true;
                db.beginTransaction();
                db.execSQL("DELETE FROM TB_ZONA");
    ...
    public boolean insertRutas(List<RutaBean> lista) {
        ...
        if (lista != null) {
            ...
            if (lista.size() > 0) {
                res = true;
                db.beginTransaction();
                db.execSQL("DELETE FROM TB_RUTA");

                for (RutaBean bean : lista) {
                    db.execSQL(
                            "INSERT or IGNORE into TB_RUTA " +
                                    "(Codigo,Nombre,Zona) values(?,?,?)",
                            new Object[]{bean.getCodigo(),
                                    bean.getNombre(),
                                    bean.getZona()});
                }
    ...
    //Registro de descuentos escalar
    public boolean insertDescuentoEscalar(ArrayList<DescuentoEscalarBean> lista) {
        ...
        if (lista != null) {
            ...
            if (lista.size() > 0) {
                ...
                delete.deleteDescuentoEscalaFull();

                db.beginTransaction();

                for (DescuentoEscalarBean model : lista) {

                    // Registrar descuento escalar->
                    ContentValues objetForInsert = new ContentValues();
                    objetForInsert.put(contexto.getResources().getString(R.string.C_DESC_ESCALA_CODE), model.getCode());
                    objetForInsert.put(contexto.getResources().getString(R.string.C_DESC_ESCALA_NAME), model.getName());
                    objetForInsert.put(contexto.getResources().getString(R.string.C_DESC_ESCALA_U_MSS_FEINI), model.getFechaInicio());
                    objetForInsert.put(contexto.getResources().getString(R.string.C_DESC_ESCALA_U_MSS_FEFI), model.getFechaFin());
                    objetForInsert.put(contexto.getResources().getString(R.string.C_DESC_ESCALA_U_MSS_OBSERV), model.getObservacion());
                    objetForInsert.put(contexto.getResources().getString(R.string.C_DESC_ESCALA_U_MSS_TIPO), model.getTipo());

                    long respuestaInsert = db.insert(contexto.getResources().getString(R.string.TB_DESCUENTO_ESCALA),
                            null, objetForInsert);
                    ...
                    if (respuestaInsert != -1) {
                        ...
                        if (model.getDetalle() != null) {
                            // Registrar contactos->
                            for (DescuentoEscalarDetalleBean _detalle : model
                                    .getDetalle()) {

                                if (!_detalle.getLineId().equalsIgnoreCase(
                                        "anytype{}")) {
                                    db.execSQL(
                                            "insert into "
                                                    + contexto.getResources().getString(R.string.TD_DESCUENTO_ESCALA_1) +
                                                    " values(?,?,?,?,?,?,?,?,?,?,?)",
                                            new Object[]{
                                                    model.getCode(),
                                                    _detalle.getLineId(),
                                                    _detalle.getCodigoArticulo(),
                                                    _detalle.getNombreArticulo(),
                                                    _detalle.getEscala1(),
                                                    _detalle.getDescuento1(),
                                                    _detalle.getEscala2(),
                                                    _detalle.getDescuento2(),
                                                    _detalle.getEscala3(),
                                                    _detalle.getDescuento3(),
                                                    _detalle.getDivision()});
    ...
    //Registro de descuentos regular
    public boolean insertDescuentoRegular(ArrayList<DescuentoRegularBean> lista) {
        ...
        if (lista != null) {
            ...
            if (lista.size() > 0) {
                ...
                delete.deleteDescuentoRegularFull();

                db.beginTransaction();

                for (DescuentoRegularBean model : lista) {

                    // Registrar descuento escalar->
                    ContentValues objetForInsert = new ContentValues();
                    objetForInsert.put(contexto.getResources().getString(R.string.C_DESC_REGULAR_CODE), model.getCode());
                    objetForInsert.put(contexto.getResources().getString(R.string.C_DESC_REGULAR_NAME), model.getName());
                    objetForInsert.put(contexto.getResources().getString(R.string.C_DESC_REGULAR_U_MSS_FEINI), model.getFechaInicio());
                    objetForInsert.put(contexto.getResources().getString(R.string.C_DESC_REGULAR_U_MSS_FEFI), model.getFechaFin());
                    objetForInsert.put(contexto.getResources().getString(R.string.C_DESC_REGULAR_U_MSS_OBSERV), model.getObservacion());
                    objetForInsert.put(contexto.getResources().getString(R.string.C_DESC_REGULAR_U_MSS_TIPO), model.getTipo());

                    long respuestaInsert = db.insert(contexto.getResources().getString(R.string.TB_DESCUENTO_REGULAR),
                            null, objetForInsert);
                    ...
                    if (respuestaInsert != -1) {
                        ...
                        if (model.getDetalle() != null) {
                            // Registrar contactos->
                            for (DescuentoRegularDetalleBean _detalle : model
                                    .getDetalle()) {
                                ...
                                if (!_detalle.getLineId().equalsIgnoreCase(
                                    ...
                                    db.execSQL(
                                            "insert into "
                                                    + contexto.getResources().getString(R.string.TD_DESCUENTO_REGULAR_1) +
                                                    " values(?,?,?,?,?)",
                                            new Object[]{
                                                    model.getCode(),
                                                    _detalle.getLineId(),
