...
public class MyDataBase extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        /**************** DESCUENTOS EFILA ******************/
        /*****************************************************/
        // TABLA DESCUENTO ESCALA
        String QUERY_CREATE_DESCUENTO_ESCALA;
        QUERY_CREATE_DESCUENTO_ESCALA = ("CREATE TABLE "
                + contexto.getResources().getString(R.string.TB_DESCUENTO_ESCALA)
                + "("
                + contexto.getResources().getString(R.string.C_DESC_ESCALA_CODE) + " TEXT, "
                + contexto.getResources().getString(R.string.C_DESC_ESCALA_NAME) + " TEXT, "
                + contexto.getResources().getString(R.string.C_DESC_ESCALA_U_MSS_FEINI) + " TEXT, "
                + contexto.getResources().getString(R.string.C_DESC_ESCALA_U_MSS_FEFI) + " TEXT, "
                + contexto.getResources().getString(R.string.C_DESC_ESCALA_U_MSS_OBSERV) + " TEXT, "
                + contexto.getResources().getString(R.string.C_DESC_ESCALA_U_MSS_TIPO) + " TEXT)");
        db.execSQL(QUERY_CREATE_DESCUENTO_ESCALA);

        String QUERY_CREATE_DESCUENTO_ESCALA_1;
        QUERY_CREATE_DESCUENTO_ESCALA_1 = ("CREATE TABLE "
                + contexto.getResources().getString(R.string.TD_DESCUENTO_ESCALA_1)
                + "("
                + contexto.getResources().getString(R.string.C_DESC_ESCALA_1_CODE) + " TEXT, "
                + contexto.getResources().getString(R.string.C_DESC_ESCALA_1_LINEID) + " TEXT, "
                + contexto.getResources().getString(R.string.C_DESC_ESCALA_1_U_MSS_COAR) + " TEXT, "
                + contexto.getResources().getString(R.string.C_DESC_ESCALA_1_U_MSS_DEAR) + " TEXT, "
                + contexto.getResources().getString(R.string.C_DESC_ESCALA_1_U_MSS_ESCA1) + " TEXT, "
                + contexto.getResources().getString(R.string.C_DESC_ESCALA_1_U_MSS_DESC1) + " TEXT, "
                + contexto.getResources().getString(R.string.C_DESC_ESCALA_1_U_MSS_ESCA2) + " TEXT, "
                + contexto.getResources().getString(R.string.C_DESC_ESCALA_1_U_MSS_DESC2) + " TEXT, "
                + contexto.getResources().getString(R.string.C_DESC_ESCALA_1_U_MSS_ESCA3) + " TEXT, "
                + contexto.getResources().getString(R.string.C_DESC_ESCALA_1_U_MSS_DESC3) + " TEXT, "
                + contexto.getResources().getString(R.string.C_DESC_ESCALA_1_U_MSS_DIVISION) + " TEXT)");
        db.execSQL(QUERY_CREATE_DESCUENTO_ESCALA_1);

        // TABLA DESCUENTO REGULAR
        String QUERY_CREATE_DESCUENTO_REGULAR;
        QUERY_CREATE_DESCUENTO_REGULAR = ("CREATE TABLE "
                + contexto.getResources().getString(R.string.TB_DESCUENTO_REGULAR)
                + "("
                + contexto.getResources().getString(R.string.C_DESC_ESCALA_CODE) + " TEXT, "
                + contexto.getResources().getString(R.string.C_DESC_ESCALA_NAME) + " TEXT, "
                + contexto.getResources().getString(R.string.C_DESC_ESCALA_U_MSS_FEINI) + " TEXT, "
                ...
                + contexto.getResources().getString(R.string.C_DESC_ESCALA_U_MSS_OBSERV) + " TEXT, "
                + contexto.getResources().getString(R.string.C_DESC_ESCALA_U_MSS_TIPO) + " TEXT)");
        db.execSQL(QUERY_CREATE_DESCUENTO_REGULAR);

        String QUERY_CREATE_DESCUENTO_REGULAR_1;
        QUERY_CREATE_DESCUENTO_REGULAR_1 = ("CREATE TABLE "
                + contexto.getResources().getString(R.string.TD_DESCUENTO_REGULAR_1)
                + "("
                + contexto.getResources().getString(R.string.C_DESC_REGULAR_1_CODE) + " TEXT, "
                + contexto.getResources().getString(R.string.C_DESC_REGULAR_1_LINEID) + " TEXT, "
                + contexto.getResources().getString(R.string.C_DESC_REGULAR_1_U_MSS_COAR) + " TEXT, "
                + contexto.getResources().getString(R.string.C_DESC_REGULAR_1_U_MSS_DEAR) + " TEXT, "
                + contexto.getResources().getString(R.string.C_DESC_REGULAR_1_U_MSS_DESC1) + " TEXT)");
        db.execSQL(QUERY_CREATE_DESCUENTO_REGULAR_1);
        ...
        QUERY_CREATE_BP = ("CREATE TABLE "
                ...
                + contexto.getResources().getString(R.string.C_SN_DESCUENTO_BASE) + " TEXT)");
        ...
        Q_CREATE_TB_ART = ("CREATE TABLE "
                ...
                + contexto.getResources().getString(R.string.C_ART_DIVISION) + " TEXT, "
...
//		
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        db.execSQL("DROP TABLE IF EXISTS " + contexto.getResources().getString(R.string.TB_DESCUENTO_REGULAR));
        db.execSQL("DROP TABLE IF EXISTS " + contexto.getResources().getString(R.string.TD_DESCUENTO_REGULAR_1));
        db.execSQL("DROP TABLE IF EXISTS " + contexto.getResources().getString(R.string.TB_DESCUENTO_ESCALA));
        db.execSQL("DROP TABLE IF EXISTS " + contexto.getResources().getString(R.string.TD_DESCUENTO_ESCALA_1));
        onCreate(db);
    }
