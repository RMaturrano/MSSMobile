...
public class Delete {
    ...
    public void deleteAll() {
        ...
        deleteDescuentoEscalaFull();
        deleteDescuentoRegularFull();
    }
    ...
    public void deleteDescuentoEscalaFull() {
        db.execSQL("delete from " + contexto.getResources().getString(R.string.TB_DESCUENTO_ESCALA));
        db.execSQL("delete from " + contexto.getResources().getString(R.string.TD_DESCUENTO_ESCALA_1));
    }

    public void deleteDescuentoRegularFull() {
        db.execSQL("delete from " + contexto.getResources().getString(R.string.TB_DESCUENTO_REGULAR));
        db.execSQL("delete from " + contexto.getResources().getString(R.string.TD_DESCUENTO_REGULAR_1));
    }
